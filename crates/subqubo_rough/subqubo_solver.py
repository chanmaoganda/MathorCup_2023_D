...
class SubQuboSolver:
    ...
    def solve(self, qubo_variables: SubQuboVariable):
        ...
        C_ren_i = self.C_ren_i
        C_wei_i = self.C_wei_i
        
        C_oil_i = self.C_oil_i
        C_oil_j = self.C_oil_j
        ...
        for sol in opt[0]:
            ...
            if total_cost > total_budget:
                ...
                if constraintViolate == False:
                    ...
                    real_obj, realwc, realkc, realzii = self.getSolution(wk, machine_values, qubo_variables)
    ...
    def getSolution(self, static_k, machine_values, qubo_variables: SubQuboVariable):
        ...
        C_cai = self.C_cai
        C_oil_j = self.C_oil_j
        C_ren_j = self.C_ren_j
        C_wei_j = self.C_wei_j
